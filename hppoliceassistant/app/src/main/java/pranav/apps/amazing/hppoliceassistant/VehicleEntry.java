...
public class VehicleEntry {
    ...
    public VehicleEntry(String vehicle_number, String phone_number, String description, String name_of_place, String naka_name, String date, String time, String officer_name,String Image) {
